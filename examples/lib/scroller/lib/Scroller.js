    ...
    Scroller.prototype = {
      ...
      */
      ...
      doTouchStart: function (touches, timeStamp) {
        ...
        if (isSingleTouch) {
          currentTouchLeft = touches[0].pageX || touches[0].x || 0;
          currentTouchTop = touches[0].pageY || touches[0].y || 0;
        } else if (touches.length >= 2) {
          currentTouchLeft = Math.abs(touches[0].pageX || touches[0].x || 0 + touches[1].pageX || touches[1].x || 0) / 2;
          currentTouchTop = Math.abs(touches[0].pageY || touches[0].y || 0 + touches[1].pageY || touches[1].y || 0) / 2;
        }
