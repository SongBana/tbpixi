        ...
        if (root.skins) {
          ...
          if (Array.isArray(root.skins)) {
            for (let i = 0; i < root.skins.length; i++) {
              let item = root.skins[i]
              console.log("skin名字", item.name)
              let skinName = item.name || 'default'
              var skinMap = item.attachments;
            ...
            for (var timelineName in slotMap) {
              ...
              if (timelineName == "attachment") {
                ...
                for (var i = 0; i < timelineMap.length; i++) {
                  ...
                  timeline.setFrame(frameIndex++, valueMap.time || 0, valueMap.name);
                }
                ...
                for (var i = 0; i < timelineMap.length; i++) {
                  ...
                  timeline.setFrame(frameIndex, valueMap.time || 0, color.r, color.g, color.b, color.a);
                ...
                for (var i = 0; i < timelineMap.length; i++) {
                  ...
                  timeline.setFrame(frameIndex, valueMap.time || 0, light.r, light.g, light.b, light.a, dark.r, dark.g, dark.b);
                  this.readCurve(valueMap, timeline, frameIndex);
                  frameIndex++;
                }
                timelines.push(timeline);
            ...
            for (var timelineName in boneMap) {
              ...
              if (timelineName === "rotate") {
                ...
                for (var i = 0; i < timelineMap.length; i++) {
                  ...
                  timeline.setFrame(frameIndex, valueMap.time || 0, valueMap.angle || 0);
                  this.readCurve(valueMap, timeline, frameIndex);
                  frameIndex++;
                }
                timelines.push(timeline);
                ...
                for (var i = 0; i < timelineMap.length; i++) {
                  var valueMap = timelineMap[i];
                  var x = this.getValue(valueMap, "x", 1), y = this.getValue(valueMap, "y", 1);
                  if (!timelineScale) {
                    debugger
                  }
                  timeline.setFrame(frameIndex, valueMap.time || 0, x * timelineScale, y * timelineScale);
                  this.readCurve(valueMap, timeline, frameIndex);
                  frameIndex++;
                }
                timelines.push(timeline);
        ...
        if (map.ik) {
          for (var constraintName in map.ik) {
            ...
            for (var i = 0; i < constraintMap.length; i++) {
              ...
              timeline.setFrame(frameIndex, valueMap.time || 0, this.getValue(valueMap, "mix", 1), this.getValue(valueMap, "bendPositive", true) ? 1 : -1, this.getValue(valueMap, "compress", false), this.getValue(valueMap, "stretch", false));
              this.readCurve(valueMap, timeline, frameIndex);
              frameIndex++;
            }
            timelines.push(timeline);
        ...
        if (map.transform) {
          for (var constraintName in map.transform) {
            ...
            for (var i = 0; i < constraintMap.length; i++) {
              ...
              timeline.setFrame(frameIndex, valueMap.time || 0, this.getValue(valueMap, "rotateMix", 1), this.getValue(valueMap, "translateMix", 1), this.getValue(valueMap, "scaleMix", 1), this.getValue(valueMap, "shearMix", 1));
              this.readCurve(valueMap, timeline, frameIndex);
              frameIndex++;
            }
            timelines.push(timeline);
            ...
            for (var timelineName in constraintMap) {
              ...
              if (timelineName === "position" || timelineName === "spacing") {
                ...
                for (var i = 0; i < timelineMap.length; i++) {
                  ...
                  timeline.setFrame(frameIndex, valueMap.time || 0, this.getValue(valueMap, timelineName, 0) * timelineScale);
                  this.readCurve(valueMap, timeline, frameIndex);
                  frameIndex++;
                }
                timelines.push(timeline);
                ...
                for (var i = 0; i < timelineMap.length; i++) {
                  ...
                  timeline.setFrame(frameIndex, valueMap.time || 0, this.getValue(valueMap, "rotateMix", 1), this.getValue(valueMap, "translateMix", 1));
                  this.readCurve(valueMap, timeline, frameIndex);
                  frameIndex++;
                }
                timelines.push(timeline);
